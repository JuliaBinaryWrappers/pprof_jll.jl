...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import pprof_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("cf2c5f97-e748-59fa-a03f-dda3c62118cb"))
platforms = [Pkg.Artifacts.unpack_platform(e, "pprof", artifacts_toml) for e in artifacts["pprof"]]
...
if best_platform === nothing
    @debug("Unable to load pprof; unsupported platform $(triplet(platform_key_abi()))")
else
